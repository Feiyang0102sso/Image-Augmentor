...
# --- Helper Functions ---
# All helper functions (load_augmentor_from_upload, get_pipeline_info, etc.)
# are unchanged. You can copy them from the previous version.
        ...
        with st.spinner("Processing... please wait."):
            ...
            if augmentor:
                ...
                if all_originals:
                    ...
                    # STEP 1: Display the logs first.
                    st.header("📝 Processing Logs")
                    st.code("\n".join(session_logs), language="log")

                    # STEP 2: Display the visuals after the logs.
